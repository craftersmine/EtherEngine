...
using craftersmine.EtherEngine.GDK;
...
namespace craftersmine.EtherEngine.GDK.GameBaseComponents
{
    ...
    public sealed class Transform
    {
        ...
        /// </summary>
        public int RendererX { get { return (int)X - StaticData.EditingScene.SceneCamera.CameraX; } }
        /// <summary>
        /// Gets current Y position to render
        /// </summary>
        public int RendererY { get { return (int)Y + StaticData.EditingScene.SceneCamera.CameraY; } }
